...
const Transfer = () => {
  ...
  return (
    <Box className="domains  transfer">
      <title>transfer</title>
      <Top data={data} />
      <Box className="search">
        <h2>{t("transfer-search-title")}</h2>
        <p>{t("transfer-search-p")} </p>
        <Box className="form" sx={{ width: { xs: "90vw", md: "60vw" } }}>
          <form>
            <input type="search" style={{ direction: "ltr" }} />
      ...
      <Box className="modern modern-domain">
        <h2 className="h">{t("free-title")}</h2>
          ...
          <Box className="box">
            <Grid container className="container">
              ...
              <Grid item xs={10} md={4}>
                <h2>{t("free-box-1-title")}</h2>
                <p className="one">{t("free-box-1-p")}</p>
              </Grid>
            </Grid>
          </Box>
          <Box className="box">
